...
ASM_OB_CATCH_SUB_edit_sum <- ASM_OB_CATCH_SUB_edit_cf %>%
  mutate(BSB_KEPTWT = case_when(SPECIES_ITIS==	'167688' & CATDISP == '1' ~ HAIL_AMOUNT_LB,TRUE ~ 0),
         BSB_DISCARDTWT = case_when(SPECIES_ITIS==	'167688' & CATDISP == '0' ~ HAIL_AMOUNT_LB,TRUE ~ 0),
...
pulled_data_cf_sum <-pulled_data_edit_cf %>%
  mutate(BSB_KEPTWT = case_when(SPECIES_ITIS==	'167688' & DISPOSITION_CODE == '011' ~ HAIL_AMOUNT_LB,TRUE ~ 0),
         BSB_DISCARDTWT = case_when(SPECIES_ITIS==	'167688' & DISPOSITION_CODE == '100' ~ HAIL_AMOUNT_LB,TRUE ~ 0),
         SUM_BSB_CATCH = BSB_KEPTWT + BSB_DISCARDTWT)
